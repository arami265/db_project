...
-- -----------------------------------------------------
-- Table `main`.`company_service`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `main`.`company_service` (
  `company_id` INT(11) NOT NULL,
  `service_id` INT(11) NOT NULL,
  PRIMARY KEY (`company_id`, `service_id`),
  INDEX `service_id` (`service_id` ASC),
  CONSTRAINT `company_service_ibfk_1`
    FOREIGN KEY (`company_id`)
    REFERENCES `main`.`company` (`company_id`),
  CONSTRAINT `company_service_ibfk_2`
    FOREIGN KEY (`service_id`)
    REFERENCES `main`.`service` (`service_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
